          ...
          <el-row  style="align-items: center">
            ...
            <el-col :span="15">
              <el-form-item prop="password_confirmation">
                <el-input type="password" v-model="editUser.password_confirmation"  placeholder="******"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <router-link :to="{name: 'UserLogin'}" class="grid-content" style="margin:10px 0">※ Quay lại trang đăng nhập</router-link>
            </el-col>
          </el-row>
        </div>
        <div style="text-align: center">
          <el-form-item>
            <el-button class="btn-sign-up" @click="create_customer('form')">Đăng ký</el-button>
          </el-form-item>
        </div>
      </el-form>
    </div>
  ...
  data() {
    var validatePass = (rule, value, callback) => {
      if (value === '') {
        ...
        if (this.editUser.password_confirmation !== '') {
        }
        callback();
      }
    };
